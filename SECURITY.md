...
2. Email security details to: security@mystira.app
3. Include:
...
- Data portability
- Consent management
- Data Protection Officer contact: dpo@mystira.app
...
- **Security Team**: security@mystira.app
- **Data Protection Officer**: dpo@mystira.app
