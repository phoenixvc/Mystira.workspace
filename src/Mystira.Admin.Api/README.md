...
using Mystira.Application.UseCases.Media;  // Use cases ✅
...
using Mystira.Application.UseCases.Scenarios;  // Use cases ✅
using Mystira.Application.Parsers;              // Parsers ✅
...
grep -r "using Mystira.Infrastructure" Controllers/
...
- **[Application](../Mystira.Application/README.md)** - Use cases invoked by this API
- **[API](../Mystira.Api/README.md)** - Client-facing API (same pattern)
- **[Infrastructure.Data](../Mystira.Infrastructure.Data/README.md)** - Shared data layer
- **[Infrastructure.Azure](../Mystira.Infrastructure.Azure/README.md)** - Shared Azure services
