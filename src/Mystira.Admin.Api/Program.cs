...
try
{
    Log.Information("Starting Mystira.Admin.Api");
    ...
    builder.Services.AddScoped<Mystira.Admin.Api.Services.IAppStatusService, Mystira.Admin.Api.Services.AppStatusService>();
    builder.Services.AddScoped<IBundleService, BundleService>();
    builder.Services.AddScoped<ICharacterMapFileService, CharacterMapFileService>();
    builder.Services.AddScoped<IMediaMetadataService, Mystira.Admin.Api.Services.MediaMetadataService>();
