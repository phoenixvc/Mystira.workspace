    ...
    >
      ...
      <div className="flex items-start gap-3 mb-3">
        <div className="flex-shrink-0">
          <div
            className={`w-12 h-12 rounded-lg flex items-center justify-center text-2xl transition-transform duration-200 ${isHovered ? "scale-110" : ""} ${getProjectTypeColor(project.type)}`}
          >
