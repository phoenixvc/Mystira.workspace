...
export function EnvironmentSelector({
  ...
  const fetchConnections = async () => {
    ...
    try {
      ...
      const sourceConns: EnvironmentConnectionStrings = await invoke(
      ...
      const destConns: EnvironmentConnectionStrings = await invoke(
        "fetch_environment_connections",
        {
          ...
          <div className="mt-3 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg text-sm">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 dark:text-gray-300 font-mono">
                  {preset.defaultDatabaseName || "MystiraDb"}
                </span>
              </div>
  ...
  return (
    <div className="mb-6">
        ...
        <div className="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-2 text-sm text-green-700 dark:text-green-400">
          ...
          <span>
            ...
            <span className="font-medium">
              {azureStatus.subscription_name || "Unknown subscription"}
            </span>
          </span>
        </div>
      ) : (
      ...
      {sourceEnvironment &&
        destEnvironment &&
        sourceEnvironment !== "custom" &&
        destEnvironment !== "custom" && (
          <div className="mt-4">
            <button
