      ...
      <div className="flex-1 flex flex-col">
        <div className="px-4 py-2 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={
                isDeploying || !repoRoot || !selectedFile.includes("main.bicep")
              }
              ...
              title={
                !selectedFile.includes("main.bicep")
                  ? "Only main.bicep can be deployed"
          ...
          {error ? (
            <div className="absolute inset-0 flex items-center justify-center bg-red-50 dark:bg-red-900/30">
              <div className="text-center p-6">
                ...
                <div className="text-red-900 dark:text-red-300 font-medium mb-2">
                  Failed to Load File
                </div>
        ...
        <div className="px-4 py-2 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
          <p className="text-xs text-gray-600 dark:text-gray-400">
            💡 Tip: Edit Bicep files in your IDE. This viewer is read-only for
            safety.
          </p>
        </div>
      </div>
