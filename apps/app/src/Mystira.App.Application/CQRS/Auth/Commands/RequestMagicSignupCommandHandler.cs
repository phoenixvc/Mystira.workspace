...
public static class RequestMagicSignupCommandHandler
{
        ...
        CancellationToken ct)
    {
        ...
        {
            pendingSignup.DisplayName = string.IsNullOrWhiteSpace(command.DisplayName)
        ...
        logger.LogInformation("Magic signup link requested for {EmailHash}. Email sent: {EmailSent}",
        ...
        return new MagicSignupResult(
            ...
            sent
                ? "Magic link sent"
                : "Request saved, email delivery failed. Please retry.");
    }
