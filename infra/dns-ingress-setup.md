...
> **📌 Note:** This guide covers production setup with base domains. For environment-specific URLs (dev.publisher.mystira.app, staging.publisher.mystira.app, etc.), see [ENVIRONMENT_URLS_SETUP.md](./ENVIRONMENT_URLS_SETUP.md).
