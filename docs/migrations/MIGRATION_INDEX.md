...
| **Service Migrations**                 | 🔄 In Progress | 45%      | App ~85%, StoryGenerator ~30%, others pending     |
...
| ---------------------- | ---------------------------------------------------------------------------- | -------- | --------------------------------------------------------- |
| Mystira.App            | [mystira-app-migration.md](./mystira-app-migration.md)                       | High     | 🔄 ~85% (Wolverine done, caching done, exceptions 85%)    |
...
- [ ] StoryGenerator: MediatR → Wolverine migration
- [ ] StoryGenerator: Polly v8 resilience
