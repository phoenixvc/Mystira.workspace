...
export type InfrastructureAction =
  (typeof INFRASTRUCTURE_ACTIONS)[keyof typeof INFRASTRUCTURE_ACTIONS];
...
export type DeploymentMethod =
  (typeof DEPLOYMENT_METHODS)[keyof typeof DEPLOYMENT_METHODS];
...
export type EnvironmentStatusValue =
  (typeof ENVIRONMENT_STATUS)[keyof typeof ENVIRONMENT_STATUS];
