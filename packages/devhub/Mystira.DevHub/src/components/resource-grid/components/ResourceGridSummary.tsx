...
export function ResourceGridSummary({
  resources,
  compact,
}: ResourceGridSummaryProps) {
  ...
  return (
    <div
      className={`flex items-center gap-4 ${compact ? "text-xs" : "text-sm"} text-gray-600 dark:text-gray-400`}
    >
      <div className="flex items-center gap-1">
        <span
          className={`font-bold text-green-700 dark:text-green-400 ${compact ? "" : "text-xl"}`}
        >
          {running}
        </span>
      ...
      <div className="flex items-center gap-1">
        <span
          className={`font-bold text-gray-700 dark:text-gray-300 ${compact ? "" : "text-xl"}`}
        >
          {stopped}
        </span>
      ...
      <div className="flex items-center gap-1">
        <span
          className={`font-bold text-yellow-700 dark:text-yellow-400 ${compact ? "" : "text-xl"}`}
        >
          {warnings}
        </span>
      ...
      <div className="flex items-center gap-1">
        <span
          className={`font-bold text-red-700 dark:text-red-400 ${compact ? "" : "text-xl"}`}
        >
          {failed}
        </span>
