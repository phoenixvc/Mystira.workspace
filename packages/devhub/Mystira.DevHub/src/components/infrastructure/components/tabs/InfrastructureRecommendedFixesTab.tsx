...
export default function InfrastructureRecommendedFixesTab({
  environment,
}: InfrastructureRecommendedFixesTabProps) {
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Security and safety improvements to prevent accidental actions and
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
            Add filters and confirmation requirements to prevent accidental
          ...
          <div className="flex flex-wrap gap-2">
            <label className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-700 dark:text-gray-300">
                Require resource name confirmation before delete
              </span>
            </label>
            <label className="flex items-center gap-2">
              <input
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">
                Hide delete buttons by default (toggle to show)
              </span>
            </label>
            <label className="flex items-center gap-2">
              <input
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">
                Filter by environment prefix before allowing delete
              </span>
            </label>
          </div>
        </div>
        ...
        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
            Require subscription owner permissions for production environment
            operations
          </p>
          <div className="space-y-2">
            <label className="flex items-center gap-2">
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">
                Require subscription owner role for prod-* resources
              </span>
            </label>
            <label className="flex items-center gap-2">
              <input
              ...
              />
              <span className="text-sm text-gray-700 dark:text-gray-300">
                Auto-detect subscription owner and validate before operations
              </span>
            </label>
          </div>
        </div>
        ...
        <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
            Automatically add required tags to Azure resources for better
