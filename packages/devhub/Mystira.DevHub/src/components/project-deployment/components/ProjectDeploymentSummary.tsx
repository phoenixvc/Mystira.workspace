        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-amber-700 dark:text-amber-300 mb-2">
              Select at least one infrastructure template from the project cards
              above to continue to deployment.
            </p>
            <div className="flex items-center gap-2 text-xs text-amber-600 dark:text-amber-400">
              <span className="font-medium">Tip:</span>
              <span>
                Check the boxes next to Storage, Cosmos DB, App Service, or Key
                Vault to select templates.
              </span>
            </div>
          </div>
        </div>
            ...
            title={
              !readyToProceed
                ? isLoading
                  ...
                  : "Select at least one infrastructure template to continue"
                : "Continue to Step 2: Infrastructure Actions"
            }
          >
            Continue to Step 2 →
          </button>
