...
function EditMasterDataPage() {
  ...
  const getApi = () => {
    ...
    switch (type) {
      case "age-groups":
        return {
          get: ageGroupsApi.getAgeGroup,
          update: ageGroupsApi.updateAgeGroup,
        };
      case "archetypes":
        return {
          get: archetypesApi.getArchetype,
          update: archetypesApi.updateArchetype,
        };
      case "compass-axes":
        return {
          get: compassAxesApi.getCompassAxis,
          update: compassAxesApi.updateCompassAxis,
        };
      case "echo-types":
        return {
          get: echoTypesApi.getEchoType,
          update: echoTypesApi.updateEchoType,
        };
      case "fantasy-themes":
        return {
