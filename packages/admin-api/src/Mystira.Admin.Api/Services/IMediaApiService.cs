...
public interface IMediaApiService
{
    ...
    Task<MediaQueryResponse> GetMediaAsync(MediaQueryRequest request, CancellationToken cancellationToken = default);
    ...
    Task<MediaAsset?> GetMediaByIdAsync(string mediaId, CancellationToken cancellationToken = default);
    ...
    Task<MediaAsset> UploadMediaAsync(IFormFile file, string mediaId, string mediaType, string? description = null, List<string>? tags = null, CancellationToken cancellationToken = default);
    ...
    Task<BulkUploadResult> BulkUploadMediaAsync(IFormFile[] files, bool autoDetectType = true, bool overwriteExisting = false, CancellationToken cancellationToken = default);
    ...
    Task<MediaAsset> UpdateMediaAsync(string mediaId, MediaUpdateRequest updateData, CancellationToken cancellationToken = default);
    ...
    Task<MediaValidationResult> ValidateMediaReferencesAsync(List<string> mediaReferences, CancellationToken cancellationToken = default);
    ...
    Task<MediaUsageStats> GetMediaUsageStatsAsync(CancellationToken cancellationToken = default);
    ...
    Task<(Stream stream, string contentType, string fileName)?> GetMediaFileAsync(string mediaId, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>The media asset or null if not found</returns>
    Task<MediaAsset?> GetMediaByFileNameAsync(string fileName, CancellationToken cancellationToken = default);
    ...
    Task<string?> GetMediaUrlAsync(string fileName, CancellationToken cancellationToken = default);
    ...
    Task<ZipUploadResult> UploadMediaFromZipAsync(IFormFile zipFile, bool overwriteMetadata = false, bool overwriteMedia = false, CancellationToken cancellationToken = default);
}
