...
export function DashboardPage() {
  ...
  const registeredCount =
    stories?.items.filter((s) => s.status === "registered").length || 0;
  const pendingCount =
    stories?.items.filter((s) => s.status === "pending_approval").length || 0;
                  ...
                  <li key={story.id}>
                    ...
                    >
                      <div className="dashboard-story__content">
                        <span className="dashboard-story__title">
                          {story.title}
                        </span>
                        {story.summary && (
                          <span className="dashboard-story__summary">
                            {story.summary}
                          </span>
                        )}
                      </div>
